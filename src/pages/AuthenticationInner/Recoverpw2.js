...
const Recoverpw2 = () => {
  ...
  //meta title
  document.title="Recover Password 2 | DashBoard - React Admin & Dashboard Template";
                  ...
                  <div className="d-flex flex-column h-100">
                    ...
                    <div className="my-auto">
                      <div>
                        ...
                        <p className="text-muted">Re-Password with DashBoard.</p>
                      </div>
                    ...
                    <div className="mt-4 mt-md-5 text-center">
                      <p className="mb-0">
                        © {new Date().getFullYear()} DashBoard. Crafted with{" "}
