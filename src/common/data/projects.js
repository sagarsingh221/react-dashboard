const projects = [
  {
    ...
    files: [
      { name: "DashBoard Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "DashBoard Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "DashBoard Logo.Zip", size: "2.02 MB", link: "#" },
